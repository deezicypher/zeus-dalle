    ...
    <section className='max-w-7xl mx-auto'>
         <div>
            ...
            <p className='mt-2 text-[#666e75] text-[14px] max-w-[500px] '>
               Generate your own Dall-e AI image 
            </p>
        </div>
...
{generatingImg? 'Generating...' : 'Generate'}
     ...
     <div className='mt-10 '>
          <p
            ...
            >Once you have created the image, you can share it
            </p>
            <button 
            type='submit'
            className='mt-3 text-white bg-[#46acff] font-meduim rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center'
            >
